...
function startAurora(canvasId, opts) {
  ...
  const blobs = [
    { hue: '150,105,255', a: 0.62, r: 0.56, cx: 0.30, cy: 0.34, ax: 0.28, ay: 0.22, T: 13, ph: 0.0 },
    { hue: '190,110,255', a: 0.54, r: 0.50, cx: 0.68, cy: 0.30, ax: 0.26, ay: 0.26, T: 17, ph: 1.7 },
    { hue: '108,199,255', a: 0.48, r: 0.44, cx: 0.50, cy: 0.62, ax: 0.34, ay: 0.20, T: 11, ph: 3.1 },
    { hue: '120,120,255', a: 0.46, r: 0.48, cx: 0.22, cy: 0.68, ax: 0.24, ay: 0.25, T: 19, ph: 4.4 },
    { hue: '255,120,220', a: 0.42, r: 0.38, cx: 0.78, cy: 0.66, ax: 0.30, ay: 0.23, T: 15, ph: 5.6 },
  ];
