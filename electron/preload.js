...
contextBridge.exposeInMainWorld("aircursor", {
  ...
  saveCapture: (payload) => ipcRenderer.send("aircursor:save-capture", payload),
  startCapture: () => ipcRenderer.invoke("aircursor:start-capture"),
  revealCaptures: () => ipcRenderer.invoke("aircursor:reveal-captures"),
  onStartCapture: (handler) => ipcRenderer.on("aircursor:start-capture", () => handler()),
